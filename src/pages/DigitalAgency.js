...
const BannerData = [
    {
        image: "/images/bg/imgMain.png",
        title: "PorterIT",
        description: "We help our clients succeed by creating quality software solutions."
    },
    // {
                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <SectionTitle
                                    ...
                                    description = "We offer these stages in the software development process for your company, <br /> each of them is essential for the success of it."
                                    />
                            </div>
                        </div>
                        <ServiceFive 
                        ...
                        <div className="row mb--25">
                            <div className="col-lg-10 offset-lg-1">
                                <SectionTitle
                                    ...
                                    description = "These are some of the skills we use to develop your system in the best possible way"
                                />
                            </div>
                        </div>
                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <SectionTitle
                                    ...
                                    title = "What our Wrending News are."
