...
const Nav = () => {
  return (
    ...
    //     <Link to="/">Inicio</Link>
      ...
      // {/* <li><Link to="/about-us">Sucursales</Link></li> */}
      // <li>
      ...
      //           <li>
      //             <Link to="/social-share">Barrio Norte</Link>
      //           </li>
      //           <li>
      //             <Link to="/blog-grid">Yerba Buena</Link>
      //           </li>
      //         </ul>
      //       </div>
      //     </div>
      ...
      // {/* <li className="has-droupdown"><Link to="/portfolio-three-column">Portfolio</Link> */}
      // {/* <ul className="submenu">
      ...
      // {/* <li><Link to="/about-us">Staff</Link></li> */}
      // {/* <li><Link to="/about-us">Preg Frecuentes</Link></li> */}
    // </ul>
  );
};
export default Nav;
